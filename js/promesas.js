...
const tomarPrimeraClase = () =>{
    return new Promise((resolve, reject) =>{
        setTimeout(()=>{
            resolve('Comenzar modulo')
            // reject('Faltar a la presentacion')
        }, 2500)
    })
}
...
.catch((error) =>{
    console.log(error)
    alert('Algo salio mal con la inscripcion del alumno')
})
